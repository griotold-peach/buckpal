package com.griotold.buckpal.archunit;
...
abstract class ArchitectureElement {
    ...
    static void denyDependency(String fromPackageName, String toPackageName, JavaClasses classes) {
        noClasses()
            .that()
            .resideInAPackage(matchAllClassesInPackage(fromPackageName))  // ✅ 파라미터 사용
            .should()
            .dependOnClassesThat()
            .resideInAnyPackage(matchAllClassesInPackage(toPackageName))  // ✅ 파라미터 사용
            .check(classes);
    }
